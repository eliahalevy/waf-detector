...
Runs WAF detection and serves the frontend.
"""
...
def detect_response_codes(base_url):
    ...
    for payload in MALICIOUS_PAYLOADS:
        ...
        if r is None:
            signals.append(("Response Code Analysis", "Unknown WAF", 2, f"Connection reset on payload"))
...
def lead():
    data = request.get_json()
    # In production: save to DB, send to CRM, email notification, etc.
